...
const projects = [
  {
    ...
    subtitle: "Full-Stack MERN System for Amsterdam Clients",
    description: "An intelligent property management system with Owner, Admin, and Tenant role-based portals. Automates lease management, maintenance tracking, and financial reporting end-to-end for real estate clients in Amsterdam.",
    bullets: [
      "Multi-role authentication (Owner, Admin, Tenant)",
      "Real-time maintenance request and status tracking",
      "Automated rent collection and payment history",
      "Property analytics with financial reporting",
    ],
  ...
  },
  {
    ...
    subtitle: "Faculty & Course Quality Analysis for IUB",
    description: "A digital feedback platform for The Islamia University of Bahawalpur. Students rate faculty performance and course quality, giving administrators data-driven insights through intuitive dashboards.",
    bullets: [
      "Multi-criteria structured feedback forms per course",
      "Real-time analytics and visual performance charts",
      "Faculty trend analysis over multiple semesters",
      "Secure role-based access for students and admins",
    ],
    tech: ["React", "TypeScript", "Supabase", "Chart.js", "Tailwind CSS"],
    status: "Production",
  ...
  },
  {
    ...
    tech: ["Python", "TensorFlow", "CNN", "React", "Flask", "OpenCV"],
    status: "Research",
  ...
  },
  {
    ...
    subtitle: "Modern E-Commerce with Admin Panel",
    description: "Polished e-commerce storefront for a ladies' bag boutique featuring a complete shopping experience and a fully operational admin panel for inventory, orders, and sales analytics.",
    bullets: [
      "Full catalog with search, filters, and categories",
